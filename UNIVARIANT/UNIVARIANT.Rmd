...
# UNIVARIANT<i class="fas fa-laptop-code"></i>



## El paisaje de R-Studio
...
# MULTIVARIANT<i class="fas fa-laptop-code"></i>

## PCA

Un Análisis de Componentes Principales es un método para reducir la dimensionalidad de un conjunto de variables NUMÉRICAS CONTINUAS. La idea es, a partir de todas las variables, crear nuevos ejes a partir de combinaciones lineales que resuman al máximo posible la varibilidad de las muestras. 
...
En el mundo de la ecologia esto se aplica a la matriz de variables ambientales, pero nosotros vamos a trabajar con `pizza.data`, un dataset real sobre características de pizzas. 
...
_Ejercicio: Mírate bien cómo he generado el biplot. Ahora intenta colorear los puntos en función de la marca de pizza_
